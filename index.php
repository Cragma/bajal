...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Inventario de BajalSoft</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-blue.png" alt="Logo" height="50"> <b>BAJALSOFT</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="username" placeholder="Ingrese su codigo de usuario" autocomplete="off" required />
