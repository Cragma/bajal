...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Stock de items
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Nombre de item</th>
            ...
            $query = mysqli_query($mysqli, "SELECT codigo,nombre,precio_compra,precio_venta,unidad,stock FROM items ORDER BY nombre ASC")
