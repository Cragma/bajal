...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Registro de items

    <a class="btn btn-primary btn-social pull-right" href="?module=form_itemsi_transaction&form=add" title="Agregar" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Datos de items han sido registrado correctamente.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.tipo_transaccion, a.codigo_transaccion,a.fecha,a.codigo,a.numero,b.codigo,b.nombre,b.unidad
                                            FROM transaccion_items as a INNER JOIN items as b ON a.codigo=b.codigo ORDER BY codigo_transaccion DESC")
