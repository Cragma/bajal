...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO transaccion_items(codigo_transaccion,fecha,codigo,numero,created_user,tipo_transaccion) 
            ...
            if ($query) {
                ...
                $query1 = mysqli_query($mysqli, "UPDATE items SET stock        = '$total_stock'
                                                              WHERE codigo   = '$codigo'")
                                                or die('Error: '.mysqli_error($mysqli));
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=itemsi_transaction&alert=1");
                }
            }   
        }   
    }
