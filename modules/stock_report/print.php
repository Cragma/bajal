...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.tipo_transaccion, a.codigo_transaccion,a.fecha,a.codigo,a.numero,b.codigo,b.nombre,b.unidad
                                    FROM transaccion_items as a INNER JOIN items as b ON a.codigo=b.codigo
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>REPORTE DE ITEM</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
           DATOS DE REGISTROS DE ITEM
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle"><small>NOMBRE DE ITEM</small></th>
...
<?php
$filename="datos de registro de items.pdf"; 
