...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Inventario de BajalSoft</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Inventario de items">
    <meta name="author" content="Inventario de items - Bajal" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:1px" src="assets/img/logo-blue.png" alt="Logo" height="30"> 
          <span style="font-size:20px">BAJALSOFT</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://oferta.senasofiaplus.edu.co/sofia-oferta/" target="_blank">BajalSoft</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
